...
public class UserMenu extends javax.swing.JFrame {
            ...
            try {
                ...
                while(rs.next()) {
                    ...
                    //System.out.println("idEmp: " + empleado[0]+ ", nombre: "+ empleado[1]+", apellidos: " + empleado[2]
                        ...
                        //+ ", correo: "+ empleado[5] + ", sucursal: "+ nombreSucursal[6]);
    ...
    private void initComponents() {
        ...
        btnListarEmpleado.setIcon(new javax.swing.ImageIcon("/Users/EdisonNaranjo/Documents/Java SE/Reto1_G56/src/main/java/Imagenes/avatar.png")); // NOI18N
    ...
    private void tblEmpleadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEmpleadoMouseClicked
        ...
        if(row < 0){
            ...
            String nombreEmp = (String) tblEmpleado.getValueAt(row, 0).toString();
            ...
            showUserForm.recibeDatos( nombreEmp, apellidos, documento, correo, sucursal);
